<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Inicio.aspx.cs" Inherits="Proyecto_Pharmacy_Online.Modulos.WebForm2" %>
...
<body>
    <form id="form1" runat="server">
        <!--Baner Superior-->
        <div class="bg-dark p-0 m-0 fondo">
            <div class="bg-success text-light text-center">
                <p class="empresa">Pharmacy Online</p>
            </div>
                ...
                <div class="col-lg-6 col-sm-12 px-0">
                    ...
                    <div class="col-12">
                        <div class="container col-8 text-center mt-5 ">
                            <asp:Label ID="Label1" runat="server" Text="Salud y confianza al alcanze de tus manos" Style="font-size: 60px; font-family: 'Harlow Solid'; color: white; text-shadow: 5px 12px 12px #000000;"></asp:Label>
                        </div>
                        <!--Imagen-->
                ...
                <div class="col-lg-6  col-sm-12 my-5 px-0 align-content-center">
                    ...
                    <asp:MultiView ID="MultiView1" runat="server">
                        ...
                        <asp:View ID="View1" runat="server">
                            <div class="col-7 container bg-success container-inicio">
                                <div class="row">
                                    <div class="col-12">
                        ...
                        <asp:View ID="View2" runat="server">
                            <div class="col-10 container bg-success container-inicio pb-2">
                                <div class="row">
                                    <div class="col-12">
                                        <img src="../imagenes/medicine.png" style="height: 80px" />
                                    </div>
